...
{
    mSurface = SDL_CreateRGBSurfaceWithFormat(0, screenBuffer.mSurface->w, screenBuffer.mSurface->h,
...
ScreenBuffer& ScreenBuffer::operator=(const ScreenBuffer& screenBuffer)
{
    ...
    {
        mSurface =
            SDL_CreateRGBSurfaceWithFormat(0, screenBuffer.mSurface->w, screenBuffer.mSurface->h, 0,
