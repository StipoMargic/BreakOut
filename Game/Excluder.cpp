...
bool Excluder::HasCollided(const AARectangle& rect, BoundaryEdge& edge) const
{
    ...
    {
        float yMin = mAARectangle.GetTopLeft().GetY() >= (rect.GetTopLeft().GetY())
                         ? mAARectangle.GetTopLeft().GetY()
                         : rect.GetTopLeft().GetY();
        float yMax = mAARectangle.GetBottomRight().GetY() <= rect.GetBottomRight().GetY()
                         ? mAARectangle.GetBottomRight().GetY()
                         : rect.GetBottomRight().GetY();

        float ySize = yMax - yMin;

        float xMin = mAARectangle.GetTopLeft().GetX() >= rect.GetTopLeft().GetX()
                         ? mAARectangle.GetTopLeft().GetX()
                         : rect.GetTopLeft().GetX();
        float xMax = mAARectangle.GetBottomRight().GetX() <= rect.GetBottomRight().GetX()
                         ? mAARectangle.GetBottomRight().GetX()
...
{
    mEdges[TOP_EDGE].edge = {mAARectangle.GetTopLeft().GetX(), mAARectangle.GetTopLeft().GetY(),
                             mAARectangle.GetBottomRight().GetX(),
                             mAARectangle.GetTopLeft().GetY()};
    mEdges[TOP_EDGE].normal = UP_DIR;

    mEdges[LEFT_EDGE].edge = {mAARectangle.GetTopLeft().GetX(), mAARectangle.GetTopLeft().GetY(),
                              mAARectangle.GetTopLeft().GetX(),
                              mAARectangle.GetBottomRight().GetY()};
    mEdges[LEFT_EDGE].normal = LEFT_DIR;

    mEdges[BOTTOM_EDGE].edge = {
        mAARectangle.GetTopLeft().GetX(), mAARectangle.GetBottomRight().GetY(),
        mAARectangle.GetBottomRight().GetX(), mAARectangle.GetBottomRight().GetY()};
    mEdges[BOTTOM_EDGE].normal = DOWN_DIR;

    mEdges[RIGHT_EDGE].edge = {
        mAARectangle.GetBottomRight().GetX(), mAARectangle.GetTopLeft().GetY(),
        mAARectangle.GetBottomRight().GetX(), mAARectangle.GetBottomRight().GetY()};
