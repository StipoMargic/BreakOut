...
class GameController
{
  public:
    ...
    inline void ClearAll() { mButtonActions.clear(); }
    // Hide SDL Implementation

    inline static bool IsPressed(InputState state) { return state == SDL_PRESSED; }

    inline static bool IsReleased(InputState state) { return state == SDL_RELEASED; }
